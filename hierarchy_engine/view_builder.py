...
class HierarchyViewBuilder:
    ...
    def rebuild_flat_view(
        ...
        """
        Rebuild the flattened hierarchy reporting view.
        """
    ...
    def rebuild_dims_view(
        ...
        """
        logger.info("Rebuilding hierarchy dims view: %s", dims_view)
    ...
    def rebuild_reporting_view(
        ...
        """
        Rebuild the final reporting view for all published versions.
        """
        logger.info("Rebuilding hierarchy reporting view: %s", reporting_view)
